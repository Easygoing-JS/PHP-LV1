<?php
        ...
        if ($cartForm != '') {
            $cartForm = '<form action="/cart/">
                            ...
                            <div>
                                ...
                                <input type="button" value="ОФОРМИТЬЗАКАЗ" disabled>
                            </div>
                        </form>';
        }
    }
        ...
        $product_name, $photo_thumb, $price)
    {
        ...
        if ($photo_thumb != '')
            ...
            $cartForm .= '<img src="/img/shablon-images/no_photo.png" alt="">';
        $cartForm .= '</a></div>';
        ...
        $cartForm .= '<div class="calc"><input class="calc-btn" type="submit" ' . $disabled . ' name="calcMinus[' . $id . ']" value="-"></div>';
        $cartForm .= '<div class="calc">' . $count . '</div>';
        $cartForm .= '<div class="calc"><input class="calc-btn" type="submit" name="calcAdd[' . $id . ']" value="+"></div>';
        $cartForm .= '<div class="calc">' . $count * $price . ' р.</div>';
        $cartForm .= '<div class="calc"><input class="calc-btn" class="btnDel" type="submit" name="delId[' . $id . ']" value="x" title="Удалить"></div>';
        $cartForm .= '</div>';
